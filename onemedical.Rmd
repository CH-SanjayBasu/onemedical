...
print(CreateTableOne(data =prem, vars = c("age", "female", "hcc", "mm", "cost_md", "cost_rx", "cost_er" ,"cost_hosp" , "cost_pcp"  , "cost_spec"  ,"cost_mh" ,"cost_pt" ,   "count_er"  , "count_hosp" ,"count_pcp" ,"count_spec", "count_mh",   "count_pt"  , "vrt_flag" ,"cnt_flag"), strata="om_flag", test = T), smd = TRUE, contDigits=3, catDigits=3, noSpaces = TRUE)
...
print(CreateTableOne(data =postm, vars = c("age", "female", "hcc", "mm", "cost_md", "cost_rx", "cost_er" ,"cost_hosp" , "cost_pcp"  , "cost_spec"  ,"cost_mh" ,"cost_pt" ,   "count_er"  , "count_hosp" ,"count_pcp" ,"count_spec", "count_mh",   "count_pt"  , "vrt_flag" ,"cnt_flag"), strata="om_flag", test = F), smd = TRUE, contDigits=3, catDigits=3, noSpaces = TRUE)
