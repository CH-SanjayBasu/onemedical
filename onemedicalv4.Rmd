...
ctr_sub = ctr_sub %>%
  select(firstname,lastname,female,em_flag,om_flag,diag1,pos,cost_md,ctr_flag)
...
pretab = print(pretable, smd = TRUE, contDigits=3, catDigits=1, noSpaces = TRUE, quote = T)
...
ctrtab = print(ctrmtable, smd = TRUE, contDigits=3, catDigits=1, noSpaces = TRUE, quote = T)
