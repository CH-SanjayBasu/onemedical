...
ctr_sub = ctr_sub %>%
  ...
  select(firstname,lastname,female,em_flag,om_flag,diag1,pos,cost_md,ctr_flag,CPT,near_flag)
...
posttab2 = print(posttable2, smd = TRUE, contDigits=3, catDigits=1, noSpaces = TRUE, quote = T)
